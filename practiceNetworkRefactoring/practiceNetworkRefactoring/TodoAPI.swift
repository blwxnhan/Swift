...
enum TodoAPI {
    ...
    var request: URLRequest {
        ...
        request.addValue("eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiI4Iiwicm9sZXMiOlsiUk9MRV9VU0VSIl0sImlhdCI6MTcwMzM5ODE2MSwiZXhwIjoxNzAzNDAxNzYxfQ.5osYZJtNClkF6TbbOu9qPJutvtsmAQl2J0ZMQE42Vgw", forHTTPHeaderField: "X-AUTH-TOKEN")
        return request
    }
